...
# We provide you with expressions containing +,-,*,^, / and parenthesis. None of the numbers in the expression involved will exceed 999999.
# Your task is to evaluate the expression and display the output correct to 33 decimal places.
