...
=====
    socket - https://manned.org/socket.3
    ﻿bind - https://manned.org/bind.3
    ﻿listen - https://manned.org/listen.3
    ﻿accept - https://manned.org/accept.3
    ﻿conect - https://manned.org/connect.3
    ﻿send - https://manned.org/send.3
    ﻿recv - https://manned.org/recv.3
    ﻿shutdown - https://manned.org/shutdown.3
    ﻿sendto - https://manned.org/sendto.3
    ﻿recvfrom - https://manned.org/recvfrom.3
    ﻿fcntl - https://manned.org/fcntl.3

В этих же руководствах интересные нюансы по применимости sendto/recvfrom к TCP, а так же connect/recv/send к UDP.
Ну и несколько мануалов по сокетам из моей коллекции:
http://beej.us/guide/bgnet/ - справочник для быстрого доступа, когда что-то позыбалось и нужно быстро вспомнить.
https://rsdn.ru/article/unix/sockets.xml (тут особенно интересно про connect вместе с SOCK_DGRAM, больше нигде этого акцента не встречал /или пропускал/)