// 1 Refactor the code from your matrix program (from 6-1.c) so that the size of a matrix is not fixed to a maximum number of elements. Instead use dynamic memory allocation.
