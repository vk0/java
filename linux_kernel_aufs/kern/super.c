...
// http://lxr.free-electrons.com/source/include/linux/fs.h?v=3.14#L1246
static int aufs_fill_sb(struct super_block *sb, void *data, int silent)
{
	...
	sb->s_fs_info = asb;
    // http://lxr.free-electrons.com/source/include/linux/fs.h?v=3.14#L1602
...
// http://lxr.free-electrons.com/source/fs/filesystems.c?v=3.14#L69
...
{
    // http://lxr.free-electrons.com/source/fs/filesystems.c?v=3.14#L101
